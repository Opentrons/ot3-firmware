...
static auto motion_controller_queue = freertos_message_queue::FreeRTOSMessageQueue<motion_controller_task::TaskMessage>{};
static auto motion_controller_task_handler = motion_controller_task::MotionControllerMessageHandler{interfaces::get_motor().motion_controller};
static auto motion_controller_task_entry = motion_controller_task::MotorControllerTask<lms::BeltConfig>{motion_controller_queue, motion_controller_task_handler};
