...
can_message_writer::MessageWriter message_writer_presence_sensor = MessageWriter(can_bus_1, NodeId::presence_sensor);

freertos_message_queue::FreeRTOSMessageQueue<presence_sensor_messages::Reading> presence_sensor_queue(
    "Presence Sensing Queue");
...
presence_sensor_class::PresenceSensor ps(ADC_comms2,presence_sensor_queue,complete_queue_presence_sensing);
presence_sensing_message_handler::PresenceSensorHandler presence_sensing_handler = presence_sensing_message_handler::PresenceSensorHandler{message_writer_presence_sensor, ps};


auto presence_sensor_dispatch_target = DispatchParseTarget<
