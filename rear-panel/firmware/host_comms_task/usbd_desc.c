...
/* Private typedef -----------------------------------------------------------*/
/* Private define ------------------------------------------------------------*/
#define USBD_VID                      0x04D8  /* Opentron's most common VID */
#define USBD_PID                      0xEF01  /* PID for rear panel  */
#define USBD_LANGID_STRING            0x0409  /* English */
#define USBD_MANUFACTURER_STRING      "Opentrons" /* Add your manufacturer string */
#define USBD_PRODUCT_HS_STRING        "RearPanel HS" /* Add your product High Speed string */
#define USBD_PRODUCT_FS_STRING        "RearPanel FS" /* Add your product Full Speed string */
