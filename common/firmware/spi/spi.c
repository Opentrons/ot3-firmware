...
struct SPI_config* commonConfig(void) {
    static uint32_t common_pins_sck_miso_mosi[3] = {GPIO_PIN_13, GPIO_PIN_14,
                                              GPIO_PIN_15};
    static uint32_t common_pins_cs[1] = {GPIO_PIN_12};
    static uint32_t common_pins_ctrl[1] = {GPIO_PIN_10};
    static uint32_t common_pins_dir[1] = {GPIO_PIN_1};
    static uint32_t common_pins_step[1] = {GPIO_PIN_8};


    static struct pin_group common_pins_sck_miso_mosi_group = {
    ...
    static struct pin_group common_pins_cs_group = {
    ...
    static struct pin_group common_pins_ctrl_group = {
    ...
    static struct pin_group common_pins_dir_group = {
    ...
    static struct pin_group common_pins_step_group = {
    ...
    struct pin_group _pg[5] = {common_pins_sck_miso_mosi_group,
...
void SPI2_configs(void) {
    struct SPI_config* SPI_config_tmp = commonConfig();
