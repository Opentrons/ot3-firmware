...
class HostCommMessageHandler {
  ...
  private:
    ...
    requires std::forward_iterator<InputIt> &&
        std::sized_sentinel_for<InputLimit, InputIt>
    auto visit_message(rearpanel::messages::EstopButtonPresentRequest &msg,
                       InputIt tx_into, InputLimit tx_limit) -> InputIt {
        auto queue_client = queue_client::get_main_queues();
        queue_client.send_system_queue(msg);
        static_cast<void>(tx_into);
    ...
    requires std::forward_iterator<InputIt> &&
        std::sized_sentinel_for<InputLimit, InputIt>
    auto visit_message(rearpanel::messages::AuxPresentRequeset &msg,
                       InputIt tx_into, InputLimit tx_limit) -> InputIt {
        auto queue_client = queue_client::get_main_queues();
        queue_client.send_system_queue(msg);
        static_cast<void>(tx_into);
    ...
    requires std::forward_iterator<InputIt> &&
        std::sized_sentinel_for<InputLimit, InputIt>
    auto visit_message(rearpanel::messages::AuxIDResponse &msg, InputIt tx_into,
                       InputLimit tx_limit) -> InputIt {
        return msg.serialize(tx_into, tx_limit);
    }
    ...
    requires std::forward_iterator<InputIt> &&
        std::sized_sentinel_for<InputLimit, InputIt>
    auto visit_message(rearpanel::messages::AuxIDRequest &msg, InputIt tx_into,
                       InputLimit tx_limit) -> InputIt {
        auto queue_client = queue_client::get_main_queues();
        queue_client.send_system_queue(msg);
        static_cast<void>(tx_into);
    ...
    requires std::forward_iterator<InputIt> &&
        std::sized_sentinel_for<InputLimit, InputIt>
    auto visit_message(rearpanel::messages::DoorSwitchStateRequest &msg,
                       InputIt tx_into, InputLimit tx_limit) -> InputIt {
        auto queue_client = queue_client::get_main_queues();
        queue_client.send_system_queue(msg);
        static_cast<void>(tx_into);
    ...
    requires std::forward_iterator<InputIt> &&
        std::sized_sentinel_for<InputLimit, InputIt>
    auto visit_message(rearpanel::messages::EstopStateRequest &msg,
                       InputIt tx_into, InputLimit tx_limit) -> InputIt {
        auto queue_client = queue_client::get_main_queues();
        queue_client.send_system_queue(msg);
        static_cast<void>(tx_into);
    ...
    requires std::forward_iterator<InputIt> &&
        std::sized_sentinel_for<InputLimit, InputIt>
    auto visit_message(rearpanel::messages::SyncStateRequest &msg,
                       InputIt tx_into, InputLimit tx_limit) -> InputIt {
        auto queue_client = queue_client::get_main_queues();
        queue_client.send_system_queue(msg);
        static_cast<void>(tx_into);
    ...
    requires std::forward_iterator<InputIt> &&
        std::sized_sentinel_for<InputLimit, InputIt>
    auto visit_message(rearpanel::messages::SyncStateResponse &msg,
                       InputIt tx_into, InputLimit tx_limit) -> InputIt {
        return msg.serialize(tx_into, tx_limit);
    }
    ...
    auto visit_message(rearpanel::messages::WriteEEPromRequest &msg,
        ...
        std::copy_n(msg.data.begin(), msg.data_length, write_req.data.begin());
        auto queue_client = queue_client::get_main_queues();
        queue_client.send_eeprom_queue(write_req);
        auto resp = rearpanel::messages::Ack{};
        return visit_message(resp, tx_into, tx_limit);
    }
