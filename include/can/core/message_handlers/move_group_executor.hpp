...
class MoveGroupExecutorHandler {
  public:
    ...
    MoveGroupExecutorHandler(
        MessageWriter &message_writer,
        move_group::MoveGroupManager<move_group_handler::max_moves_per_group, move_group_handler::max_groups> &motion_group_manager, Motor & motor)
        : message_writer{message_writer},
        motion_group_manager{motion_group_manager}, motor(motor), task_entry{message_writer, motor}, ack_task("ack task", task_entry) {}
    MoveGroupExecutorHandler(const MoveGroupExecutorHandler &) = delete;
    MoveGroupExecutorHandler(const MoveGroupExecutorHandler &&) = delete;
    MoveGroupExecutorHandler &operator=(const MoveGroupExecutorHandler &) = delete;
    MoveGroupExecutorHandler &&operator=(const MoveGroupExecutorHandler &&) = delete;
  ...
  private:
    ...
    MessageWriter &message_writer;
    move_group::MoveGroupManager<move_group_handler::max_moves_per_group, move_group_handler::max_groups> &motion_group_manager;
    Motor & motor;
