 ...
 *
 * A typical reading from this sensor would look like
 * `<humidity><humidity_crc><temperature><temperature_crc>`,
 * regardless of whether you use the single read setting or the
