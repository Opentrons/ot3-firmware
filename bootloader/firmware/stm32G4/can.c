...
HAL_StatusTypeDef MX_FDCAN1_Init(FDCAN_HandleTypeDef* handle) {
    ...
    handle->Init.NominalPrescaler = 17;
    handle->Init.NominalSyncJumpWidth = 1;
    handle->Init.NominalTimeSeg1 = 15;
    handle->Init.NominalTimeSeg2 = 4;
    handle->Init.DataPrescaler = 17;
    handle->Init.DataSyncJumpWidth = 1;
    handle->Init.DataTimeSeg1 = 15;
    handle->Init.DataTimeSeg2 = 4;
