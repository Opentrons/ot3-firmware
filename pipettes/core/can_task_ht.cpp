...
static auto& linear_motor_driver_queue_client = linear_motor_tasks::tmc2160_driver::get_queues();
...
static auto eeprom_handler =
    eeprom::message_handler::EEPromHandler{sensor_queue_client};
...
static auto sensor_handler = sensors::handlers::SensorHandler{sensor_queue_client};
...
static auto motor_dispatch_target = dispatch_builder::TMC2160MotorDispatchTarget{can_motor_handler};

static auto motion_controller_dispatch_target = dispatch_builder::MotionControllerDispatchTarget{can_motion_handler};

static auto motion_group_dispatch_target = dispatch_builder::MoveGroupDispatchTarget{can_move_group_handler};

static auto eeprom_dispatch_target = dispatch_builder::EEPromDispatchTarget{eeprom_handler};

static auto system_dispatch_target = dispatch_builder::SystemDispatchTarget{system_message_handler};

static auto sensor_dispatch_target = dispatch_builder::SensorDispatchTarget{sensor_handler};

static auto pipette_info_target = dispatch_builder::PipetteInfoDispatchTarget{pipette_info_handler};
...
static auto dispatcher = can_dispatch::Dispatcher(
    ...
    motion_controller_dispatch_target, sensor_dispatch_target,
    eeprom_dispatch_target, pipette_info_target, system_dispatch_target);
